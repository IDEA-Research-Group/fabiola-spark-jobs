...
object ModelDefinitions {
 ...
 |      model.sum(terminoPotencia(i), "=", TP(i)).post()
  ...
  def main(args: Array[String]) = {
    println(conquenseDef.domainData.replaceAll("\n", "\\\\n").replaceAll("\"", "\\\\\""))
    println(conquenseDef.variables.replaceAll("\n", "\\\\n").replaceAll("\"", "\\\\\""))
    println(conquenseDef.constraints.replaceAll("\n", "\\\\n").replaceAll("\"", "\\\\\""))
    println(conquenseDef.objective.replaceAll("\n", "\\\\n").replaceAll("\"", "\\\\\""))
    println(conquenseDef.solution.replaceAll("\n", "\\\\n").replaceAll("\"", "\\\\\""))
  }
